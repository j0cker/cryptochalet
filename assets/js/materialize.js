 ...
 *
 * original requestAnimationFrame polyfill by Erik MÃƒÂ¶ller
...
function PickerConstructor( ELEMENT, NAME, COMPONENT, OPTIONS ) {
    ...
    var
        ...
        P = PickerInstance.prototype = {
            ...
            start: function() {
                ...
                // Trigger queued the Ã¢â‚¬Å“startÃ¢â‚¬Â and Ã¢â‚¬Å“renderÃ¢â‚¬Â events.
            ...
            render: function( entireComponent ) {
                ...
                // Trigger the queued Ã¢â‚¬Å“renderÃ¢â‚¬Â events.
            ...
            stop: function() {
                ...
                // Trigger the queued Ã¢â‚¬Å“stopÃ¢â‚¬Â events.
                P.trigger( 'stop' )
            ...
            open: function( dontGiveFocus ) {
                ...
                // Add the Ã¢â‚¬Å“activeÃ¢â‚¬Â class.
                $ELEMENT.addClass( CLASSES.active )
                aria( ELEMENT, 'expanded', true )

                // * A Firefox bug, when `html` has `overflow:hidden`, results in
                //   killing transitions :(. So add the Ã¢â‚¬Å“openedÃ¢â‚¬Â state on the next tick.
                //   Bug: https://bugzilla.mozilla.org/show_bug.cgi?id=625289
                setTimeout( function() {

                    // Add the Ã¢â‚¬Å“openedÃ¢â‚¬Â class to the picker root.
                ...
                if ( dontGiveFocus !== false ) {
                    ...
                    // Pass focus to the root elementÃ¢â‚¬â„¢s jQuery object.
                    // * Workaround for iOS8 to bring the pickerÃ¢â‚¬â„¢s root into view.
                    P.$root.eq(0).focus()
                    ...
                    $document.on( 'click.' + STATE.id + ' focusin.' + STATE.id, function( event ) {
                        ...
                        // Check if there is a key movement or Ã¢â‚¬Å“enterÃ¢â‚¬Â keypress on the element.
                            ...
                            // On Ã¢â‚¬Å“enterÃ¢â‚¬Â, if the highlighted item isnÃ¢â‚¬â„¢t disabled, set the value and close.
                        ...
                        // If the target is within the root and Ã¢â‚¬Å“enterÃ¢â‚¬Â is pressed,
                ...
                // Trigger the queued Ã¢â‚¬Å“openÃ¢â‚¬Â events.
            ...
            close: function( giveFocus ) {
                ...
                // Remove the Ã¢â‚¬Å“activeÃ¢â‚¬Â class.
                $ELEMENT.removeClass( CLASSES.active )
                aria( ELEMENT, 'expanded', false )

                // * A Firefox bug, when `html` has `overflow:hidden`, results in
                //   killing transitions :(. So remove the Ã¢â‚¬Å“openedÃ¢â‚¬Â state on the next tick.
                //   Bug: https://bugzilla.mozilla.org/show_bug.cgi?id=625289
                setTimeout( function() {

                    // Remove the Ã¢â‚¬Å“openedÃ¢â‚¬Â and Ã¢â‚¬Å“focusedÃ¢â‚¬Â class from the picker root.
                ...
                // Trigger the queued Ã¢â‚¬Å“closeÃ¢â‚¬Â events.
            ...
            set: function( thing, value, options ) {
                ...
                // When the method isnÃ¢â‚¬â„¢t muted, trigger queued Ã¢â‚¬Å“setÃ¢â‚¬Â events and pass the `thingObject`.
    ...
    function prepareElement() {
        ...
        $ELEMENT.
            ...
            // Add the Ã¢â‚¬Å“inputÃ¢â‚¬Â class name.
    ...
    function prepareElementRoot() {
        ...
        P.$root.
            ...
            on({
                ...
                // to the doc and remove the Ã¢â‚¬Å“focusedÃ¢â‚¬Â state from the root.
            ...
            // Add/remove the Ã¢â‚¬Å“targetÃ¢â‚¬Â class on focus and blur.
            on({
                focus: function() {
            ...
            // Open the picker and adjust the root Ã¢â‚¬Å“focusedÃ¢â‚¬Â state
            ...
            on( 'click', '[data-pick], [data-nav], [data-clear], [data-close]', function() {
                ...
                // If a Ã¢â‚¬Å“clearÃ¢â‚¬Â button is pressed, empty the values and close with focus.
    ...
    function handleKeydownEvent( event ) {
        ...
        // For some reason IE clears the input value on Ã¢â‚¬Å“escapeÃ¢â‚¬Â.
        if ( keycode == 27 ) {
            P.close()
            return false
        }
    ...
    function handleFocusToOpenEvent( event ) {
        ...
        // If itÃ¢â‚¬â„¢s a focus event, add the Ã¢â‚¬Å“focusedÃ¢â‚¬Â class to the root.
        if ( event.type == 'focus' ) {
...
function DatePicker( picker, settings ) {
    ...
    // If thereÃ¢â‚¬â„¢s no value, default to highlighting Ã¢â‚¬Å“todayÃ¢â‚¬Â.
    else {
        calendar.
            set( 'select', null ).
...
DatePicker.prototype.create = function( type, value, options ) {
    ...
    // that itÃ¢â‚¬â„¢s a valid date Ã¢â‚¬â€œ otherwise default to today.
    else if ( $.isArray( value ) ) {
        value = new Date( value[ 0 ], value[ 1 ], value[ 2 ] )
        value = _.isDate( value ) ? value : calendar.create().obj
    }

    // If itÃ¢â‚¬â„¢s a number or date object, make a normalized date.
 ...
 * literal Ã¢â‚¬Å“trueÃ¢â‚¬Â, or integer relative to another time.
 */
...
DatePicker.prototype.disabled = function( dateToVerify ) {
    ...
    var
        ...
        isDisabledMatch = calendar.item.disable.filter( function( dateToDisable ) {
            ...
            // If itÃ¢â‚¬â„¢s an object, match a date within the Ã¢â‚¬Å“fromÃ¢â‚¬Â and Ã¢â‚¬Å“toÃ¢â‚¬Â range.
    ...
    // Check the calendar Ã¢â‚¬Å“enabledÃ¢â‚¬Â flag and respectively flip the
...
DatePicker.prototype.isDateExact = function( one, two ) {
    ...
    // When weÃ¢â‚¬â„¢re working with date representations, compare the Ã¢â‚¬Å“pickÃ¢â‚¬Â value.
    if (
    ...
    // When weÃ¢â‚¬â„¢re working with range objects, compare the Ã¢â‚¬Å“fromÃ¢â‚¬Â and Ã¢â‚¬Å“toÃ¢â‚¬Â.
...
/**
 * Flip the Ã¢â‚¬Å“enabledÃ¢â‚¬Â state.
 */
...
/**
 * Mark a collection of dates as Ã¢â‚¬Å“disabledÃ¢â‚¬Â.
 */
...
/**
 * Mark a collection of dates as Ã¢â‚¬Å“enabledÃ¢â‚¬Â.
 */
    ...
    // Otherwise go through the disabled dates.
        ...
        datesToEnable.map(function( unitToEnable ) {
            ...
            for ( index = 0; index < disabledItemsCount; index += 1 ) {
                ...
                // When an overlapped match is found, add the Ã¢â‚¬Å“invertedÃ¢â‚¬Â state to it.
            ...
            // make sure there are no Ã¢â‚¬Å“invertedÃ¢â‚¬Â dates because of it.
...
return _.node(
    ...
    _.node('div',
	    ...
	    // * For Firefox forms to submit, make sure to set the buttonsÃ¢â‚¬â„¢ `type` attributes as Ã¢â‚¬Å“buttonÃ¢â‚¬Â.
	    _.node(
		'div',
